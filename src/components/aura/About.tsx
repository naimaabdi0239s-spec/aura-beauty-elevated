...
export function About() {
  return (
    <section id="about" className="bg-secondary">
      <div className="mx-auto grid max-w-[1560px] items-center gap-14 px-6 py-24 md:px-12 md:py-36 lg:grid-cols-2 lg:gap-24">
        <Reveal className="order-2 lg:order-1">
          <p className="eyebrow">The Aura Approach</p>
          <h2 className="mt-7 max-w-md font-display text-4xl md:text-[3.4rem]">
            Where expertise meets <span className="italic">intention.</span>
          </h2>
          <p className="mt-8 max-w-md text-[0.95rem] leading-[1.95] text-muted-foreground">
          ...
          <a href="#contact" className="btn-base btn-solid mt-11">
            Discover Aura
          </a>
        </Reveal>
