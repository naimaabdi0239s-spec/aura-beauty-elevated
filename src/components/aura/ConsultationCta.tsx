...
export function ConsultationCta() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1560px] px-6 py-20 text-center md:px-12 md:py-28">
        <Reveal>
          <h2 className="mx-auto max-w-2xl font-display text-4xl md:text-[4rem]">Not sure where to start?</h2>
        </Reveal>
        <Reveal delay={120}>
          <p className="mx-auto mt-6 max-w-md text-[0.95rem] leading-[1.9] text-muted-foreground">
