...
export function Intro() {
  return (
    <section className="mx-auto max-w-[1560px] px-6 py-36 md:px-12 md:py-56">
      <div className="mx-auto max-w-3xl text-center">
        <Reveal>
          <p className="eyebrow">A More Considered Approach to Aesthetics</p>
        </Reveal>
        <Reveal delay={120}>
          <h2 className="mt-10 font-display text-5xl md:text-[5rem] leading-[0.9]">
            Beauty, <span className="italic">with intention.</span>
          </h2>
        </Reveal>
        <Reveal delay={220}>
          <p className="mx-auto mt-12 max-w-xl text-[0.98rem] leading-[1.9] text-muted-foreground">
