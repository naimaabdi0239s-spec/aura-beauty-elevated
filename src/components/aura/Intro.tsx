...
export function Intro() {
  return (
    <section className="mx-auto max-w-[1560px] px-6 py-28 md:px-12 md:py-44">
      <div className="mx-auto max-w-3xl text-center">
        <Reveal>
          <p className="eyebrow">A More Considered Approach to Aesthetics</p>
        </Reveal>
        <Reveal delay={120}>
          <h2 className="mt-8 font-display text-5xl md:text-[4.5rem]">
            Beauty, <span className="italic">with intention.</span>
          </h2>
        </Reveal>
        <Reveal delay={220}>
          <p className="mx-auto mt-9 max-w-xl text-[0.98rem] leading-[1.9] text-muted-foreground">
